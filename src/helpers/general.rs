...
use std::fs;
//wrap ai function return strign reference
//Extend ai function to encourage speficic output

const CODE_TEMPLATE_PATH: &str ="/Users/machd/Documents/auto-gpt/web-template/src/code_template.rs";


pub const WEB_SERVER_PROJECT_PATH:&str = "/Users/machd/Documents/auto-gpt/web-template/src/web_template.rs";

pub const EXEC_MAIN_PATH: &str ="/Users/machd/Documents/auto-gpt/web-template/src/main.rs";

const API_SCHEMA_PATH: &str ="/Users/machd/Documents/auto-gpt/web-template/src/api_schema.rs";
...
mod tests{
 ...
 #[test]
    fn tests_call_to_openai(){
    
    let extended_msg:Message = extend_ai_function(convert_user_input_to_goal,"dummy variables");
    // let x_str = convert_user_input_to_goal("dummy variables");
